...
class Affectations extends BaseController
{
    ...
    public function professeur($professeurId = null)
    {
        $professeurId = $professeurId !== null ? (int) $professeurId : null;

        return $this->response->setJSON((new AffectationsModel())->getAllAssignementsProf($professeurId));
    }
}
